			...
			<div class="row">
				<div class="col col-md-8 col col-sm-8" id="presentation">
					...
					<p class="chapeau">Nous vous proposons de cristaliser votre model business, 
						...
						<div class="button btn-blue"><a href="getup-ecommerce-prestige-mars_detail.html">Découvrir la session</a></div>
					</div> 
							...
							<div class="col-xs-12">
								<div class="cadre-arrondi bg-white vignette vignette-haut" id="cdc">
									...
									<ul>
										...
										<li>Il m'apprend à utiliser le backoffice du système de gestion de contenu et comment mettre mon site en ligne.</li>
										<li>Je découvre les bases du développement internet avec les langages HTML et CSS.</li>
										<li>Je suis capable de faire évoluer le contenu et l'apparence de mon site.</li>
										<li>Je connais les bases du référencement internet et de la rédaction de contenu optimisé pour Google.</li>
									</ul>
								</div>
							</div>					
						</div>
						...
						<div class="row cadre-arrondi cadre-2 bg-green">
							<div  id="commerce" class="col col-md-6 cadre-arrondi-gauche bg-white vignette vignette-haut">
								...
								<ul>
									...
									<li>J'ai appris les bases du code informatique.</li>
									<li>Je comprends les enjeux de la création de site internet et du développement de mon entreprise.</li>
								</ul>						
							</div>
							<div id="conclusion" class="col col-md-6 cadre-arrondi-droit text-center">
