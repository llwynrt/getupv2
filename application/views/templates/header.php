                    ...
                    <li>
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
							...
							<ul class="dropdown-menu">
								<li>
									<a href="getup-ecommerce-prestige-mars.html">Session e-commerce prestige</a>
								</li>
								<li>
									<a href="getup-prix-libre.html">Session à prix libre</a>
								</li>
							</ul>
					</li>
                    <li>
                   	...
                   	<li>
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
							...
							<ul class="dropdown-menu">
								<li>
									<a href="creersession.html">Créer une session</a>
								</li>
								<li>
									<a href="postuler.html">Intervenir sur une session</a>
								</li>
							</ul>
